...
public class Fog : MonoBehaviour
{
	...
	{
		return FogData.Instance.isActiveAndEnabled;
	}
	...
	private void _UpdateFog( )
	{
		...
		else
		{
			...
			if( transform.position.z < 0 ) { fog_limits = fog_data.fogFront; depth_01 *= -1; } //Send properties if object is in fog boundaries. 
